...
def get_paper_string(x):
    ...
    if (EMPTY_ABSTRACT) and (EMPTY_DESCRIPTION):
        return (
            "Researchers wrote a paper with an empty abstract and an empty description."
        )
    elif EMPTY_ABSTRACT:
        return (
            "Researchers wrote a paper with an empty abstract With the following description: "
            + x["description"]
        )
    elif EMPTY_DESCRIPTION:
        return (
            "Researchers wrote a paper with the following abstract: "
            + x["abstracts"]
